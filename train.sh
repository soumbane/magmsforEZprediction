...
python train.py /media/user1/MyHDataStor41/Soumyanil_EZ_Pred_project/Data/All_Hemispheres/Lobe_Data_exp7/ /home/user1/Desktop/Soumyanil_EZ_Pred_project/Models/magmsforEZprediction/trained_models/magms_exp7.model -b 128 -lr 1e-3 --num_mod 5 -e 50 -exp magms_exp7.exp --replace_experiment --show_verbose --device cuda:2
