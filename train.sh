python train.py /home/neil/Lab_work/Jeong_Lab_Multi_Modal_MRI/Lobe_Data/ /home/neil/Lab_work/Jeong_Lab_Multi_Modal_MRI/magmsforEZprediction/trained_models_lobe/magms_lobe_smote_train_orig_val.model -b 96 -lr 1e-3 --num_mod 5 -e 50 -exp magms_lobe_smote_train_orig_val.exp --replace_experiment --show_verbose --device cuda:0
