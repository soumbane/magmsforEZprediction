...
python train.py /home/user1/Desktop/Soumyanil_EZ_Pred_project/Data/All_Hemispheres/ROI_Data/ /home/user1/Desktop/Soumyanil_EZ_Pred_project/Models/magmsforEZprediction/trained_models/magms_exp5.model -b 42 -lr 1e-3 --num_mod 5 -e 50 -exp magms_exp5.exp --replace_experiment --show_verbose --device cuda:3
