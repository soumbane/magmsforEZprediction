...
def main(root: str, save_path_training: str, save_path_testing: str, save_path_validation: str, num_samples_nonEZ: int = 50, num_samples_EZ: int = 50):    
    ...
    X_combined_train, Y_combined_train, X_combined_test, Y_combined_test = load_model_cohort(root, num_samples_nonEZ=num_samples_nonEZ, num_samples_EZ=num_samples_EZ, random_state=100)  # type:ignore   
    ...
    save_dir_test_temp = 'Test_NonEZvsEZ_WB_orig'
...
if __name__ == "__main__":
    ...
    save_path_training = '/home/neil/Lab_work/Jeong_Lab_Multi_Modal_MRI/Lobe_Data/SMOTE_Augmented_Data/'
    ...
    main(root, save_path_training, save_path_testing, save_path_validation, num_samples_nonEZ=20000, num_samples_EZ=20000)
