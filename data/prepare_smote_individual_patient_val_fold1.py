...
def val_split(X: np.ndarray, Y: np.ndarray, fold: str = "1", num_nodes: int = 827):
    ...
    if fold == "1": # Last 14 patients for validation/First 54 patients for training
        ...
        # For the validation set of 1 patient and its augmentations
        ...
        # For patient 55(J0040) - SF1/MR1
        patient = 55
        patient_range_start = (patient-1)*num_nodes
        patient_range_end = patient*num_nodes
        Y_val_temp = Y[patient_range_start:patient_range_end]

        print('Original Y_val: %s' % Counter(Y_val_temp))       

        individual_ones_val = sum(Y_val_temp)
        individual_zeros_val = 827 - individual_ones_val

        aug_ones_pat_55 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_55)

        aug_start_ind = 68*num_nodes + augmented_ones_train
        aug_end_ind = aug_start_ind + aug_ones_pat_55

        aug_end_ind_temp = aug_end_ind

        # X_val = np.concatenate((X[patient_range_start:patient_range_end,:], X[aug_start_ind:aug_end_ind,:]), axis=0)
        # Y_val = np.concatenate((Y[patient_range_start:patient_range_end], Y[aug_start_ind:aug_end_ind]), axis=0)

        # print('Augmented Y_val: %s' % Counter(Y_val))

        ############################################################################################################

        # For patient 56(J0041) - SF0/MR0
        patient = 56
        patient_range_start = (patient-1)*num_nodes
        patient_range_end = patient*num_nodes
        Y_val_temp = Y[patient_range_start:patient_range_end]
        ...
        aug_ones_pat_56 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_56)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_56

        aug_end_ind_temp = aug_end_ind

        # X_val = np.concatenate((X_val, X[patient_range_start:patient_range_end,:], X[aug_start_ind:aug_end_ind,:]), axis=0)
        # Y_val = np.concatenate((Y_val, Y[patient_range_start:patient_range_end], Y[aug_start_ind:aug_end_ind]), axis=0)
        ...
        aug_ones_pat_57 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_57)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_57
        ...
        aug_ones_pat_58 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_58)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_58
        ...
        aug_ones_pat_59 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_59)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_59
        ...
        aug_ones_pat_60 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_60)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_60
        ...
        aug_ones_pat_61 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_61)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_61
        ...
        aug_ones_pat_62 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_62)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_62
        ...
        aug_ones_pat_63 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_63)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_63
        ...
        aug_ones_pat_64 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_64)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_64
        ...
        aug_ones_pat_65 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_65)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_65
        ...
        aug_ones_pat_66 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_66)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_66
        ...
        aug_ones_pat_67 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_67)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_67
        ...
        aug_ones_pat_68 = individual_zeros_val - individual_ones_val
        aug_ones_list.append(aug_ones_pat_68)

        aug_start_ind = aug_end_ind_temp
        aug_end_ind = aug_start_ind + aug_ones_pat_68
        ...
        print("Augmented ones list sum: ", np.sum(aug_ones_list))
        print("Fold 1")

    return X_val, Y_val  # type:ignore
...
def save_aug_data_as_separate_nodes(save_dir: str, X: np.ndarray, Y: np.ndarray, mode: str = "valid") -> None:
    ...
    for i in range(len(Y)):
        if mode == "train":
            raise NotImplementedError("Train mode not required for sub-group analysis.")
...
def main(root: str, k_neighbors: int = 5, num_nodes: int = 3, fold_no: str = "1"):    
    ...
    # split the data into individual validation patient and its augmentations 
    X_val, Y_val = val_split(X_aug_all_patients, Y_aug_all_patients, fold=fold_no, num_nodes=num_nodes) # type:ignore
    ...
    # save the individual patient and its augmented validation data 
    save_dir_val = 'Val_NonEZvsEZ_WB_SubGroup_Analysis'
    if not os.path.exists(save_dir_val):
        os.makedirs(save_dir_val)
    # save_path = os.path.join(save_dir_val,'Fold1','SF1') # For SF1
    # save_path = os.path.join(save_dir_val,'Fold1','MR1') # For MR1
    
    # save_path = os.path.join(save_dir_val,'Fold1','SF0') # For SF0
    save_path = os.path.join(save_dir_val,'Fold1','MR0') # For MR0

    save_aug_data_as_separate_nodes(save_path, X_val, Y_val, mode="valid")  # type:ignore
