# Use SMOTE with KNN=1 to augment EZ predict dataset to balance both classes
import os
import numpy as np
...
def main(root: str, k_neighbors: int = 5, num_nodes: int = 3, fold_no: str = "1"):    
    ...
    X_train, Y_train = augment_data(X_train_orig, Y_train_orig, k_neighbors = k_neighbors, random_state=100) # type:ignore
