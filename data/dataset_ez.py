...
if __name__ == "__main__":
    ...
    print("Whole Brain Original Val EZ Dataset ...")
    ez_dataset = DatasetEZ_WB_Val_Original(batch_size=1, root='/home/neil/Lab_work/Jeong_Lab_Multi_Modal_MRI/magmsEZpred/', drop_last=False, mode=EZMode.VALIDATE, fold_no="1", shuffle=False)
