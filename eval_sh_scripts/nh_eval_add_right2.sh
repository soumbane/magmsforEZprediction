...
# Log file
LOG_FILE="logs_add_right2/evaluation_progress.log"
...
do
    ...
    echo "$(date) - Completed: ${node_num}" >> logs_add_right2/completed_nodes.txt
done
...
# Save the process ID
PID=$!
echo $PID > logs_add_right2/evaluation_pid.txt
