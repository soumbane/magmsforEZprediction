...
if __name__ == "__main__":
    ...
    for i in num_trials:
        ...
        val_sheet[select_data_bal_acc] = val_bal_acc
        val_sheet[select_data_sen] = val_sen
        val_sheet[select_data_spec] = val_spec

        train_sheet[select_data_bal_acc] = train_bal_acc
        train_sheet[select_data_sen] = train_sen
        train_sheet[select_data_spec] = train_spec
