...
if __name__ == "__main__":
    ...
    for j in range(1,32): 
        ...
        for i in range(num_trials):  
            ...
            # configs.model = base_exp_model + "/exp_node" + str(configs.node_num) + "/magms_trial" + str(i+1) + ".exp/checkpoints/best_bal_accuracy.model" # for part 1
    ...
    # filename_val = "results_LeftTemp_val_FULL_Modality_Only.xlsx"
    # save_filepath_val = os.path.join(save_path, filename_val)
