...
for node_num in node_nums:
    ...
    file_path_val = os.path.join(base_path, "Node_" + node_num + "_Results", "Eval_Results", "results_LeftHemis_val_FULL_Modality_Part_2_Probs.xlsx") # For FULL modality Only
...
combined_df_val.to_excel('LeftHemis_val_Probs_Full_Modality.xlsx', index=False)
