...
# Train every left hemisphere node on the original SMOTE-augmented training data (58 patients),
# selecting the best checkpoint on the 17 subjects of the additional cohort that have all five sequences.
#
# Runs all 286 nodes sequentially. For a parallel run, use the shards in train_sh_scripts/nh_train_add_left*.sh
