...
if __name__ == "__main__":
    ...
    path = {
        "add": "/media/user1/MyHDataStor41/Soumyanil_EZ_Pred_project/Data/All_Hemispheres/AddCohort/Left_Hemis/",
        "orig": "/media/user1/MyHDataStor41/Soumyanil_EZ_Pred_project/Data/All_Hemispheres/Left_Hemis/Part_2/",
    }[configs.cohort]
