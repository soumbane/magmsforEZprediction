...
for node_num in "${node_nums[@]}"; do    
    ...
    python train_left.py /media/user1/MyHDataStor41/Soumyanil_EZ_Pred_project/Data/All_Hemispheres/Left_Hemis/Part_2/ /media/user1/MyHDataStor41/Soumyanil_EZ_Pred_project/Models/magmsforEZprediction/trained_models/magms_trained_last_lefthemis.model -b 4 -lr 1e-2 --num_mod 4 --node_num ${node_num} --train_mod T1-T2-FLAIR-DWI -e 30 -exp ${exp_file} --replace_experiment --show_verbose --device cuda:0
